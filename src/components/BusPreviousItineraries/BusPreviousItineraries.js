...
import "./BusPreviousItineraries.css";

// --- ICONS ---
const CloseIcon = () => (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>);
const BusIcon = () => (<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="6" width="18" height="12" rx="2"/><path d="M6 22v-2"/><path d="M18 22v-2"/><path d="M3 11h18"/><path d="M10 6v5"/><path d="M14 6v5"/></svg>); // Placeholder
...
const BusPreviousItineraries = ({ bookingData, onClose }) => {
    ...
    useEffect(() => {
        const fetchHistory = async () => {
            try {
                // Fetch Bus history
                const response = await fetch(`/server/trip_reschedule?rowId=${bookingData.rowId}&requestType=bus`);
        ...
        <div className="history-overlay">
            <div className="history-modal">
                ...
                <div className="history-header">
                    <h3>Previous Itineraries (Bus)</h3>
                                ...
                                <div className="card-details-row">
                                    ...
                                    <div className="detail-col left-col">
                                        <div className="info-item">
                                            <BusIcon />
                                            {/* Add specific Bus details if any (e.g., Seat No) */}
                                            <span className="label">Bus Booking</span>
                                        </div>
                                    ...
                                    <div className="detail-col right-col">
                                        <div className="trip-route">
                                            <div className="route-point">
                                                ...
                                                <div className="city-val">{item.BUS_DEP_CITY}</div>
                                            </div>
                                            ...
                                            <div className="route-point">
                                                ...
                                                <div className="city-val">{item.BUS_ARR_CITY}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
export default BusPreviousItineraries;