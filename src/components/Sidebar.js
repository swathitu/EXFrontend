...
const Icon = ({ name }) => {
  ...
  switch (name) {
    ...
    case "user": return (<svg {...common}><path d="M16 21v-2a4 4 0 0 0-8 0v2"/><circle cx="12" cy="7" r="4"/></svg>);

    case "caret": return (<svg {...common}><path d="M6 9l6 6 6-6"/></svg>);

    case "caret-up": return (<svg {...common}><path d="M18 15l-6-6-6 6"/></svg>);

    case "plus": return (<svg {...common}><path d="M12 5v14M5 12h14"/></svg>);

    case "home": return (<svg {...common}><path d="M3 10.5l9-7 9 7"/><path d="M9 22V12h6v10"/></svg>);

    case "trip": return (<svg {...common}><path d="M3 10h18l-1.5 9a2 2 0 0 1-2 1.7H6.5a2 2 0 0 1-2-1.7L3 10z"/><path d="M8 10V6a4 4 0 0 1 8 0v4"/></svg>);

    case "settings": return (<svg {...common}><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06A1.65 1.65 0 0 0 15 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 12 8.6a1.65 1.65 0 0 0 1.65-1.35l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 15 12c0 .3.08.6.2.86z"/></svg>);

    case "arrow-left": return (<svg {...common}><path d="M15 18l-6-6 6-6" /></svg>);

    case "arrow-right": return (<svg {...common}><path d="M9 6l6 6-6 6" /></svg>);

    case "user-master": return (<svg {...common}><path d="M16 21v-2a4 4 0 0 0-8 0v2"/><circle cx="12" cy="7" r="4"/><path d="M12 2v20M2 12h20"/></svg>);

    case "department-master": return (<svg {...common}><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2z"/><path d="M2 7H22M12 12v5m0-5h8m-8 0h-8"/></svg>);

    case "location-master": return (<svg {...common}><path d="M20.5 10.5c0 5.25-8.5 11-8.5 11S3.5 15.75 3.5 10.5a8.5 8.5 0 1 1 17 0z"/><circle cx="12" cy="10.5" r="3"/></svg>);
