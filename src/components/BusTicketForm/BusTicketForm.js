              ...
              <div className="form-ticket" key={row.id}>
                ...
                <div className="field">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateRow(row.id, "carrierName", e.target.value)
                    }
                ...
                <div className="field">
                  ...
                  <div className="date-time">
                    <input
                      ...
                      onChange={(e) =>
                        updateRow(row.id, "departDate", e.target.value)
                      }
                    />
                    <input
                      type="time"
                      ...
                      onChange={(e) =>
                        updateRow(row.id, "departTime", e.target.value)
                      }
                    />
                  </div>
                  <select
                  ...
                  <p className="location">
                    Depart from: {getCityDisplay(row.depCity)}
                  </p>
                </div>
                ...
                <div className="field">
                  ...
                  <div className="date-time">
                    <input
                      ...
                      onChange={(e) =>
                        updateRow(row.id, "arriveDate", e.target.value)
                      }
                    />
                    <input
                      type="time"
                      ...
                      onChange={(e) =>
                        updateRow(row.id, "arriveTime", e.target.value)
                      }
                    />
                  </div>
                  <select
