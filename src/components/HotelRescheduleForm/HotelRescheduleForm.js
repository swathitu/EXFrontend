...
import "./HotelRescheduleForm.css";
...
const cityOptions = [
    ...
    { cityCode: "BLR", cityName: "Bangalore Urban" },
    { cityCode: "BLR_R", cityName: "Bangalore Rural" } 
];
...
const HotelRescheduleForm = ({ bookingData, onClose, onSave }) => {
  ...
  const handleSave = () => {
    ...
    console.log("Sending Hotel Reschedule Payload:", payload);
    ...
    <div className="reschedule-overlay">
      <div className="reschedule-modal">
        ...
        <div className="reschedule-body">
            ...
            <div className="form-row location-desc-row">
                <div className="grid-col">
                    <label className="field-label">Location</label>
                    <div className="select-wrapper-border">
                        <select name="location" value={formData.location} onChange={handleChange} className="full-width-select">
            ...
            {/* Removed Star Rating and Room Type Section */}
...
export default HotelRescheduleForm;